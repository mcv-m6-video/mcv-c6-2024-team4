...
def calculate_operations(model, clip_length, crop_height, crop_width, input_channel) -> int:
    """
    ...
    """
    mock_input = torch.randn(1, input_channel, clip_length, crop_height, crop_width)
