...
def train(
    ...
    for batch in pbar:
        ...
        # Forward pass
        outputs = model(clips_rgb, clips_of)
        # Compute loss
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(f'../pretrained/aggregation.pth', map_location='cpu'))
    
    # Use NLLLoss instead of CrossEntropyLoss since the latter applies LogSoftmax (which our model already applies) + NLL Loss
    loss_fn = nn.NLLLoss()
