...
import wandb
WANDB_PROJECT = "c6_week5"
WANDB_ENTITY = "mcv_jordi"
...
if __name__ == "__main__":
    ...
    # Initialize wandb
    wandb.init(project=WANDB_PROJECT, entity=WANDB_ENTITY, name='baseline', config=args)
    ...
    for epoch in range(args.epochs):
        ...
        wandb.log({
            'Mean Training Loss': train_loss, 
            'Mean Validation Loss': val_loss, 
