...
if __name__ == "__main__":
    ...
    mean_val_loss, val_acc = evaluate(model, loaders['testing'], loss_fn, args.num_segments, args.num_spatial_crops, args.device, description=f"Testing")
    
    print("Using Nt", args.num_segments, "clips and ", args.num_spatial_crops, "crops per clip")
    print("Test Loss:", mean_val_loss, "Test Accuracy:", val_acc)
    print("\n")
