...
class HMDB51Dataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            input_size (int): Size of the input image (squares).
            temporal_stride (int): Receptive field of the model will be (clip_length * temporal_stride) / FPS.
            shuffle_frames (bool): Whether to randomly shuffle the frames of the sequences during training. Default as False.
        """
    ...
    def collate_fn(self, batch: list) -> dict:
        ...
        if self.regime == HMDB51Dataset.Regime.TRAINING:
            if self.shuffle_frames:
                # We can choose to shuffle the frames during training to ignore temporal information.
                unbatched_clips = [clip[torch.randperm(clip.shape[0])] for clip in unbatched_clips]
